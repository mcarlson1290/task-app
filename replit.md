...
### Key Features
- **Authentication**: Enterprise Microsoft SSO authentication using Azure AD (@growspace.farm domain restriction), role-based access control (technician, manager, corporate), automatic user provisioning with role detection from staff data, secure session management.
